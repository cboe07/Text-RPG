# This is preocedural approach to a text based rpg game
# The hero is fighting a goblin
# He has the option to :

# 1. fight
# 2. do nothing (goblin will stil attack)
# 3. run
